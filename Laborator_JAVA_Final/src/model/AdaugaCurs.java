...
public class AdaugaCurs {

    private int index = 10;
    public AdaugaCurs()
    {
        File std = new File("cursuri.csv");
        //creating a new frame
        JFrame f = new JFrame("Adauga Curs");
        ...
        l3 = new JLabel("Descriere :");
        l3.setBounds(50,150,150,30);

        l4 = new JLabel("ID Profesor :");
        l4.setBounds(50,200,120,30);

        l5 = new JLabel("ID Studenti :");
